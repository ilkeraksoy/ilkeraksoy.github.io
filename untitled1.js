...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 4183568,
    DYNAMIC_BASE = 9426448,
    DYNAMICTOP_PTR = 4183392;
...
var wasmBinaryFile = 'untitled1.wasm';
...
// {{PRE_LIBRARY}}
  ...
  function _emscripten_get_now() { abort() }function _clock_gettime(clk_id, tp) {
  ...
  var _fetch_work_queue=4183552;function __emscripten_get_fetch_work_queue() {
  ...
  var ___tm_current=4183408;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 4183456, 4), 4183456);
...
var dynCall_viiiiiiiiiddd = Module["dynCall_viiiiiiiiiddd"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["dynCall_viiiiiiiiiddd"].apply(null, arguments)
};
